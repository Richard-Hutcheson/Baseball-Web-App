...
teamID VARCHAR(3),
leagueID VARCHAR(2),
PlayedInGame VARCHAR(1),
startingPos smallint(6),
PRIMARY KEY (AllStarRowID)
);

CREATE TABLE Awards (
AwardsRowID int NOT NULL AUTO_INCREMENT,
...
Triples smallint(6),
HomeRuns smallint(6),
RunsBattedIn smallint(6),
StolenBases smallint(6),
CaughtStealing smallint(6),
BaseOnBalls smallint(6),
StrikeOuts smallint(6),
IntentionalWalks smallint(6),
HitByPitch smallint(6),
SacrificeHits smallint(6),
SacrificeFlies smallint(6),
GroundedIntoDoublePlays smallint(6),
...
DivisionRowID int NOT NULL AUTO_INCREMENT,
...
TriplePlays smallint(6),
PassedBallsByCatchers smallint(6),
WildPitchesByCatchers smallint(6),
OpponentStolenBasesByCatchers smallint(6),
...
GamesPlayedCenterField smallint(6),
GamesPlayedRightField smallint(6)
);
...
teamID VARCHAR(3),
parkID VARCHAR(6),
debutGameDate VARCHAR(255),
endGameDate VARCHAR(255),
gamesPlayed int(11),
datesPlayed VARCHAR(255),
attendance int(11)
);
...
inseason smallint(6),
half VARCHAR(100),
GamesManaged smallint(6),
Wins smallint(6),
Losses smallint(6),
rank smallint(6),
plyrMgr VARCHAR(1),
isSeasonHalf VARCHAR(2),
...
IPouts INT(11),
Hits smallint(6),
EarnedRuns smallint(6),
Homeruns smallint(6),
Walks smallint(6),
Strikeouts smallint(6),
OpponentsBattingAvg double,
EarnedRunAvg double,
IntentionalWalks smallint(6),
WildPitches smallint(6),
BattersHitByPitch smallint(6),
Balks smallint(6),
BattersFacedByPitcher smallint(6),
GamesFinished smallint(6),
RunsAllowed smallint(6),
SacrificesByOpposingBatters smallint(6),
SacrificeFliesByOpposingBatters smallint(6),
GIDPByOpposingBatter smallint(6),
round VARCHAR(10),
isPostSeason VARCHAR(2)
);
